...
//rtcamp admin setting menu to upload images for slider
...
function slider_shortcode( $atts=null, $content = null ) {
  ...
  $sql = "SELECT * FROM slider_images";
    ...
    $slides = "<div id='banner-fade'>
    <ul class='bjqs'>";
	while($row = $result->fetch_assoc()) {

		$slides .= "<li style='list-style:none;'><img src='".$row['slider_image']."' ></li>";
	}
	$slides .= "</ul>
	</div>
...
add_shortcode( 'myslideshow', 'slider_shortcode' );
